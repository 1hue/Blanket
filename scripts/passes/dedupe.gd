...
func _init_uniforms() -> void:
	...
	], SurfaceShaders.dedupe.shader, 0)
...
func _init_slot_buffer() -> void:
	...
	rd.buffer_update(buffer, 0, buffer_size, slot_init)
...
func compute() -> void:
	...
	rd.compute_list_bind_uniform_set(compute_list, uniforms.source_set, 1)
