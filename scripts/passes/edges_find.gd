...
func _init_uniforms() -> void:
	...
	], SurfaceShaders.edges_find.shader, 2)
...
func _init_indirect_dispatch() -> void:
	...
	], SurfaceShaders.edges_find.shader, 3)
...
func compute() -> void:
	...
	rd.compute_list_bind_compute_pipeline(compute_list, SurfaceShaders.edges_find.pipeline)
