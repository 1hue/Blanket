...
var in_uniform_sets: Array[RID] # set 0 = Verts, set 1 = Indices & Atrributes
...
func _notification(what) -> void:
	if what == NOTIFICATION_PREDELETE:
		for rid in [
			in_uniform_set, faces_uniform_set, faces_buffer,
			edges_uniform_set, edges_buffer, verts_selection_uniform_set,
			verts_in_uniform_set, out_uniform_set,
			depth_in_uniform_set, depth_out_uniform_set, out_in_map_buffer
		]:
