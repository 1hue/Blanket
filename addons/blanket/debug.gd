...
func _init(p_mesh: ArrayMesh, p_surface: BlanketSurface, p_sets: BlanketSets, p_params: BlanketParams) -> void:
...
func dump() -> void:
	...
	dump_uvec3(sets.dispatch_buffer, "dispatch")
	#dump_verts()
	#dump_faces()
	#debug_shared_edges()
	#dump_face_edges()
